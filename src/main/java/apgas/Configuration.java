...
public final class Configuration<T> {
   ...
   * is elastic. Possible values are:
   *
   * <ul>
   *   <li>fixed: (default), no change in the number of places during execution
   *   <li>evolving: (Not implemented yet), the running program may initiate requests for additional
   ...
   *   <li>1 : Nodes are filled one after the other. This can result in hosts without places
   * </ul>
   */
   ...
   * master node (String property). Normally, this property is set by the runtime automatically.
   *
  ...
  public static final Configuration<Integer> CONFIG_APGAS_BACKUPCOUNT =
      new Configuration<>(APGAS_BACKUPCOUNT_PROPERTY, 1, Integer.class);

  /** Configuration object for {@link #APGAS_CONSOLEPRINTER_PROPERTY} */
  public static final Configuration<Boolean> CONFIG_APGAS_CONSOLEPRINTER =
      new Configuration<>(APGAS_CONSOLEPRINTER_PROPERTY, false, Boolean.class);

  /**
   * Property defining if the program is allowed to change the number of running processes during
   * execution.
   */
  ...
  public static final Configuration<Integer> CONFIG_APGAS_HOSTMANAGER_STRATEGY =
  ...
  public static final Configuration<String> CONFIG_APGAS_MASTER =
      new Configuration<>(APGAS_MASTER_PROPERTY, String.class);

  /** Configuration for property {@value #APGAS_MAX_THREADS_PROPERTY} */
  public static final Configuration<Integer> CONFIG_APGAS_MAX_THREADS =
  ...
  /**
   * Initializes all the {@link Configuration} objects and reads the properties from the runtime to
   * assign the adequate values to these objects
   */
