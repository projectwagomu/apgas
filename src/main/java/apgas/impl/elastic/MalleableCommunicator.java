 ...
 * runtime. This class serves as the recipient for malleable requests coming from the scheduler and
 * the sender for evolving requests coming from running programs.
 *
...
public abstract class MalleableCommunicator {
   ...
   * MalleableCommunicator is disabled
   */
   ...
   */
  protected final void malleableGrow(int nbPlacesToGrow, List<String> hosts) {
   ...
   * to the communicator to shutdown cleanly.
   */
