...
public class ElasticOrder {
   ...
   * </ul>
   *
   * <p>This program then expects to receive the released hosts from the running program, one host
   * per line. These hostnames are printed on the standard output of this program. <strong>grow
   * case</strong> The arguments expected are:
   *
   * <ul>
   *   <li>grow
